(function () {
    ...
    var blurFilter = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "filter"
    );
    blurFilter.setAttribute("id", "svgBlurFilter");
    var feGaussianFilter = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "feGaussianBlur"
    );
    ...
    // Drop Shadow Filter
    var dropShadowFilter = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "filter"
    );
    ...
    var feFlood = document.createElementNS(
        "http://www.w3.org/2000/svg",
        "feFlood"
    );
    ...
    Filters._svgDropshadowFilterBlur.setAttribute(
        "stdDeviation",
        1 * blurScale + " " + 1 * blurScale
    );
    Filters._svgDropshadowFilterOffset.setAttribute(
        "dx",
    ...
    Filters._svgDropshadowFilterFlood.setAttribute(
        "flood-color",
        "rgba(0, 0, 0, 1)"
    );
